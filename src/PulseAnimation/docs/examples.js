export const controlledExample = `() => {
  ...
  return (
       <Layout>
        <Cell span="8">
          <PulseAnimation onEnd={()=>setActive(false)} active={active}>
            <Button>
              Button
            </Button>
          </PulseAnimation>
...
export const loopExample = `() => {
  ...
  return (
      <Layout>
        <Cell span='8'>
          <PulseAnimation loop active={active}>
            <FormField labelPlacement="left" label="Field label">
              <Input />
            </FormField>
          </PulseAnimation>
...
export const delayExample = `() => {
  ...
  return (
      <Layout>
        <Cell span='8'>
          <PulseAnimation onEnd={()=>setActive(false)} delay="500ms" active={active}>
...
export const childSizeExamples = `() => {
  ...
  <Layout>
    <Cell>
      <Layout>
        <Cell span='5'>
          <PulseAnimation onEnd={()=>setActive1(false)} active={active1}>
    ...
    <Cell>
      <Layout>
        <Cell span='8'>
          <PulseAnimation onEnd={()=>setActive2(false)} active={active2}>
