...
export default {
  ...
  sections: [
    header({
      component: <PulseAnimation children={<div />} />,
    }),
      ...
      tab({
        ...
        sections: [
          description({
            title: 'Description',
            text:
              '`<PulseAnimation/>` component is a wrapper that contains predefined bounce animation. It is used to emphasize UI elements with bounce motion.',
          }),
